...
var modelsResource = schema.GroupVersionResource{Group: "apps.dtwave.com", Version: "v1", Resource: "models"}
...
func (c *FakeModels) List(ctx context.Context, opts v1.ListOptions) (result *appsv1.ModelList, err error) {
	...
	list := &appsv1.ModelList{ListMeta: obj.(*appsv1.ModelList).ListMeta}
	for _, item := range obj.(*appsv1.ModelList).Items {
