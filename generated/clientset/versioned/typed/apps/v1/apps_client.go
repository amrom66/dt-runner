...
import (
	...
	"dt-runner/generated/clientset/versioned/scheme"
	"net/http"
...
// AppsV1Client is used to interact with features provided by the apps.dtwave.com group.
type AppsV1Client struct {
	restClient rest.Interface
}

func (c *AppsV1Client) Cis(namespace string) CiInterface {
	return newCis(c, namespace)
}

func (c *AppsV1Client) Models(namespace string) ModelInterface {
