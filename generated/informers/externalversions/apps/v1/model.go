...
func (f *modelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1.Model{}, f.defaultInformer)
}

func (f *modelInformer) Lister() v1.ModelLister {
	return v1.NewModelLister(f.Informer().GetIndexer())
}
